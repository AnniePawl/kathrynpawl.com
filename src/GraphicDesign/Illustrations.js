...
export default function Illustrations(){
    ...
    return(
        <div class='overflow-hidden bg-zinc-50 h-fit w-screen flex flex-col items-center justify-center py-28'>
            <h2 class='pb-3 text-base md:text-lg font-bold uppercase tracking-widest text-zinc-900 '>Illustrations</h2>
            {/* Menu */}
            <div class='mb-8 w-full max-w-6xl flex items-center justify-center'>
            ...
            <div class='w-full max-w-6xl pb-10 flex flex-col items-center justify-center px-4'>
                {/* Stawberries */}
                <div class='w-full max-w-6xl pb-2 flex items-center justify-center'>
                ...
                <div class='flex grid grid-cols-2 gap-2 md:grid-cols-3 w-full pb-2 '>
                    <div class='flex h-56 md:h-96 w-full bg-center bg-cover '  style={{ backgroundImage:`url(${pic7})` }}></div>
                    <div class='flex h-56 md:h-96 w-full bg-center bg-cover'  style={{ backgroundImage:`url(${pic11})` }}></div>
                    <div class='flex h-56 md:h-96 w-full bg-center bg-cover '  style={{ backgroundImage:`url(${pic8})` }}></div>
                    <div class='flex h-56 md:h-96 w-full bg-center bg-cover '  style={{ backgroundImage:`url(${pic10})` }}></div>
                    <div class='flex h-56 md:h-96 w-full bg-center bg-cover'  style={{ backgroundImage:`url(${pic12})` }}></div>
                    <div class='flex h-56 md:h-96 w-full bg-center bg-cover '  style={{ backgroundImage:`url(${pic15})` }}></div>
                </div>
                {/* planet + moon */}
                <div class='w-full max-w-6xl pb-2 flex items-center justify-center'>
                    <div class='mr-1 flex items-center justify-center h-fit w-full bg-white'>
                        <div class='h-48 w-48 sm:h-48 sm:w-48 md:h-96 md:w-96 bg-center bg-cover '  style={{ backgroundImage:`url(${pic13})` }}></div>
                    </div>
                    <div class='ml-1 flex items-center justify-center  h-fit w-full bg-[#181a27]'>
                        <div class=' h-48 w-48 sm:h-48 sm:w-48 md:h-96 md:w-96 bg-center bg-cover '  style={{ backgroundImage:`url(${pic14})` }}></div>
                    </div>
                </div>
            </div>
            ...
            <div class='w-full max-w-6xl pb-10 flex items-center justify-center px-4 '>
                <div class='flex grid grid-cols-2 gap-2 md:grid-cols-3 w-full pb-2 '>
                    <div class='flex h-56 md:h-96 w-full bg-center bg-cover '  style={{ backgroundImage:`url(${pic3})` }}></div>
                    <div class='flex h-56 md:h-96 w-full bg-center bg-cover'  style={{ backgroundImage:`url(${pic4})` }}></div>
                    <div class='flex h-56 md:h-96 w-full bg-center bg-cover '  style={{ backgroundImage:`url(${pic5})` }}></div>
                </div>
            </div>
            {/* MEDICAL */}
            ...
            <div class='w-full max-w-6xl pb-10 flex items-center justify-center px-4 '>
                    <div class='flex grid grid-cols-2 gap-2 md:grid-cols-3 w-full pb-2 '>
                        <div class='flex h-56 md:h-96 w-full bg-center bg-cover '  style={{ backgroundImage:`url(${pic9})` }}></div>
                        {/* <div class='flex h-56 md:h-96 w-full bg-center bg-cover'  style={{ backgroundImage:`url(${pic4})` }}></div>
                        <div class='flex h-56 md:h-96 w-full bg-center bg-cover '  style={{ backgroundImage:`url(${pic5})` }}></div> */}
                    </div>
            </div>
            ...
            <div class='w-full max-w-6xl pb-10 flex items-center justify-center px-4 '>
                <div class='flex w-full h-96 bg-cover bg-center'  style={{ backgroundImage:`url(${pic16})` }}></div>
