...
export default function ProjectCard({h1,h2,p,img}){
	return(
		<div class='flex flex-col'>
			...
			<p class='mb-0 text-xs text-zinc-800 md:text-sm leading-5 md:leading-6 tracking-wider font-poppins'>{p}</p>
			<div class='card  transition-all hover:scale-[.98] mt-4 md:mt-5 flex self-center rounded-sm w-full h-[300px] md:h-[500px] bg-cover bg-center p-6' style={{ backgroundImage:`url(${img})` }}></div>
		</div>
	)	
}