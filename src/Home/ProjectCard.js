...
export default function ProjectCard({h1,h2,p,img}){
	return(
		<div class='dot flex flex-col hover:cursor-default'>
			<h2 class='dot pt-0 font-roboto uppercase flex text-base md:text-lg font-[500] tracking-widest text-zinc-800'>{h1}</h2>
			...
			<p class='dot mb-0 text-xs text-zinc-800 md:text-sm leading-5 md:leading-6 tracking-wider font-poppins'>{p}</p>
