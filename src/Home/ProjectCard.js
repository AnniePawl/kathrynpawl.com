...
export default function ProjectCard({h1,h2,p,img}){
	return(
		<div class='flex flex-col'>
			<h2 class='pt-0 font-roboto uppercase flex text-base md:text-xl font-[700] tracking-wide text-zinc-900'>{h1}</h2>
			...
			<p class='mb-0 text-xs md:text-sm leading-5 md:leading-6 tracking-wide font-roboto'>{p}</p>
