    ...
    return(
        <div id='projects' className='relative z-[100] md:z-[9] bg-white h-fit w-screen block flex  justify-center flex-col  flex'>
            <div class='w-full px-6 xl:px-24 pt-12 md:pt-16 pb-12 md:pb-20 '>
                {/* CASE STUDIES */}
                <h2 id='caseStudies' class='mb-2 text-rose-700  text-base md:text-xl font-medium uppercase tracking-wide md:tracking-wider '>Case Studies</h2>
                <div class='mb-8 md:mb-12 w-full h-[1.5px] bg-rose-700'></div>
                ...
                {/* Graphic Design */}
                <h2 id='graphicDesign' class='mt-16 md:mt-20 mb-2 text-sky-600  text-base md:text-xl font-medium uppercase tracking-wide md:tracking-wider '>Graphic Design</h2>
                <div class='mb-8 md:mb-12 w-full h-[1.5px] bg-sky-600'></div>
                <div className='grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-20'>
                ...
                {/* Product Design */}
                <h2 id='productDesign' class='mt-16 md:mt-20 mb-2 text-emerald-600   text-base md:text-xl font-medium uppercase tracking-wide md:tracking-wider '>Product Design</h2>
                <div class=' mb-8 md:mb-12 w-full h-[1.5px] bg-emerald-600'></div>
                <div className='grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-20'>
