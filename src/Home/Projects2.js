...
return(
    ...
    <div id='projects' className='relative z-[9] bg-white h-fit w-screen block flex  justify-center flex-col  flex'>
        <div class='w-full px-6 md:px-24 pt-16 pb-20 '>
            {/* CASE STUDIES */}
            <h2 id='caseStudies' class='mb-2 text-rose-700   text-base md:text-2xl font-medium uppercase tracking-widest '>Case Studies</h2>
            ...
            {/* Graphic Design */}
            <h2 id='graphicDesign' class='mt-20 mb-2 text-sky-600   text-base md:text-2xl font-medium uppercase tracking-widest '>Graphic Design</h2>
            <div class=' mb-12 w-full h-[1.5px] bg-[#1b547a] '></div>
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-20'>
            ...
            {/* Product Design */}
            <h2 id='productDesign' class='mt-20 mb-2 text-emerald-600   text-base md:text-2xl font-medium uppercase tracking-widest '>Product Design</h2>
            <div class=' mb-12 w-full h-[1.5px] bg-[#1b547a] '></div>
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-20'>
