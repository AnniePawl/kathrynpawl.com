...
export default function Nav(props){
    ...
    return(
        <div className='hidden'>
            {/* Hamburger Menu */}
            <div onClick={hamburger} className='z-20 fixed top-5 left-5 hover:cursor-pointer'>
            ...
            {/* Nav Slideout */}
            <div className={`z-10 ${active?'left-0':'-left-64'} ${theme=='theme1'?'theme1-nav':''} ${theme=='theme2'?'theme2-nav':''} ${theme=='theme3'?'theme3-nav':''} ${theme=='theme4'?'theme4-nav':''} h-screen w-64 bg-yellow-300 absolute top-0 transition-all`}>
