...
export default function Widgets(){
    ...
    return(
        <div class='bg-zinc-50 h-fit w-screen flex justify-center flex-col items-center pt-28 '>
           ...
           {/* Weather App  */}
            <div className="max-w-7xl flex grid grid-cols-1 md:grid-cols-2 gap-1 md:gap-4 mb-16">
                <img class='max-h-[500px]' src={weather1}></img>
                <img class='max-h-[500px]' src={weather2}></img>
            </div>
            {/* Calculator App  */}
            <div className="max-w-7xl flex items-center justify-center grid grid-cols-1 md:grid-cols-3 gap-1 md:gap-4 mb-16">
                <img class='md:max-h-[500px]' src={calc1}></img>
