...
export default function HomeHeader(){
    ...
    return(
        <div class='relative'>
            {/* Header */}
            <div className='header w-full bg-transparent md:bg-white fixed z-[8] md:z-[200] px-2 md:px-20 h-fit w-screen py-0 md:py-6 top-0 left-0' >
                ...
                {/* <p class='uppercase text-zinc-50 tracking-wider'>Kathryn Pawl</p> */}
					<div class=' mt-8 md:mt-2 md:mt-0 flex w-full lg:w-fit  justify-end'>
